...
final class ResourceList extends Component
{
    ...
    public function save(): void
    {
        ...
        if ($this->editingId === null) {
            PromptRegistryResource::query()->create(['team_id' => $teamId, ...$attributes]);
        } else {
    ...
    {
        return view('module-automation-prompt-registry-livewire::resource-list', [
    ...
    private function query()
    {
        ...
        return PromptRegistryResource::query()->when(
            $teamId === null,

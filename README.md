# Automation: Prompt Registry Livewire
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-automation-prompt-registry-livewire?sort=semver)](https://github.com/liberusoftware/module-automation-prompt-registry-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-automation-prompt-registry-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-automation-prompt-registry-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-automation-prompt-registry-livewire
```
...
<a href="https://github.com/liberusoftware/module-automation-prompt-registry-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-automation-prompt-registry-livewire" alt="Contributors to liberusoftware/module-automation-prompt-registry-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-automation-prompt-registry-livewire/graphs/contributors).
